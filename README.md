...
[![keir.dev](https://img.shields.io/badge/keir.dev-6f42c1?style=flat-square&logo=portfolio&logoColor=white)](https://keir.is-a.dev)
[![Blog](https://img.shields.io/badge/-F0773A?style=flat-square&logo=firefox-browser&logoColor=white)](https://keir.is-a.dev/posts)
...
- `~~A wolf on the chase~~` of balancing the art of building on the web with the discipline of systems engineering.
- My personal website is [keir.dev](https://keir.is-a.dev). It's simple and serious, much like those of other fellowmates.

#### Currently working on :
- [**Scholr link**](https://github.com/keirsalterego/scholr.link)
  *Post-to-Fund DApp. Blink-powered, one-tap funding for student innovation on Solana. Track your impact with Soulbound Patron NFTs.*
- [**Noxy**](https://github.com/keirsalterego/noxy)
  *A high-performance, extensible Node.js(going to shift to rust) proxy with advanced features like DNS-over-HTTPS, custom routing (Tor/I2P), and SSL pinning for granular traffic control.*
